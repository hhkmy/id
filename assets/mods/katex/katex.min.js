!(function (e, t) {
  ...
  return (function () {
    ...
    const E = {
      ...
      D = function (e) {
        return (
          "string" != typeof e && (e = e.unit), e in E || e in L || "ex" === e
        );
      },
      V = function (e, t) {
        let r;
    ...
    var Oe = {
      ...
      staticSvg: function (e, t) {
        const [r, n, o] = He[e],
          ...
          a = Ne(["overlay"], [i], t);
        return (
          (a.height = o), (a.style.height = P(o)), (a.style.width = P(n)), a
        );
      },
      svgData: He,
      tryCombineChars: (e) => {
      ...
      Qe = function (e, t, r, n) {
        ...
        if (1 === e.length) {
          ...
          "sizing" === r.type
            ...
            : "styling" === r.type && (s = t.havingStyle(Ke[r.style]));
        }
          ...
          et(
            ...
            (e, t) => {
              ...
              "mbin" === r && l.contains(Ze, n)
                ? (t.classes[0] = "mord")
                : "mbin" === n && l.contains($e, r) && (e.classes[0] = "mord");
            },
            { node: i },
            a,
            h,
          ...
          et(
            ...
            (e, t) => {
              const r = nt(t),
                n = nt(e),
                o =
                  r && n ? (e.hasClass("mtight") ? Pe[r][n] : Ve[r][n]) : null;
    ...
    function at(e, t) {
      ...
      a.length > 0 && s.push(it(a, t)),
        r
          ? ((i = it(Qe(r, t, !0))), (i.classes = ["tag"]), s.push(i))
          : o && s.push(o);
    ...
    class ht {
      ...
      toNode() {
        ...
        for (let t = 0; t < this.children.length; t++)
          if (
            this.children[t] instanceof ct &&
            this.children[t + 1] instanceof ct
          ) {
            let r = this.children[t].toText() + this.children[++t].toText();
            for (; this.children[t + 1] instanceof ct; )
              r += this.children[++t].toText();
            e.appendChild(new ct(r).toNode());
    ...
    function xt(e, t, r, n, o) {
      ...
      return (
        ...
        Oe.makeSpan([o ? "katex" : "katex-mathml"], [c])
      );
    }
    const wt = function (e) {
        return new O({
      ...
      zt = function (e, t) {
        const {
          ...
          if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
            ...
            return { span: Oe.makeSvgSpan([], [c], t), minWidth: 0, height: l };
          }
          {
            const e = [],
              o = St[n],
    ...
    const Ct = (e, t) => {
        ...
        if (n.isStretchy)
          ...
          let e, r;
          "\\vec" === n.label
            ? ((e = Oe.staticSvg("vec", t)), (r = Oe.svgData.vec[1]))
            : ((e = Oe.makeOrd({ mode: n.mode, text: n.label }, t, "textord")),
              (e = Q(e)),
              (e.italic = 0),
              (r = e.width),
              a && (c += e.depth)),
      ...
      Nt = (e, t) => {
        const r = e.isStretchy
          ...
          n = new mt.MathNode("mover", [yt(e.base, t), r]);
    ...
    Ye({
      ...
      Ye({
        ...
        mathmlBuilder: (e, t) => {
          const r = Mt(e.label),
            n = new mt.MathNode("munder", [yt(e.base, t), r]);
    ...
    Ye({
      ...
      mathmlBuilder(e, t) {
        ...
        if (
          ...
          const o = It(yt(e.body, t));
          if (e.below) {
            const s = It(yt(e.below, t));
            n = new mt.MathNode("munderover", [r, s, o]);
          } else n = new mt.MathNode("mover", [r, o]);
        } else if (e.below) {
          const o = It(yt(e.below, t));
          n = new mt.MathNode("munder", [r, o]);
        } else (n = It()), (n = new mt.MathNode("mover", [r, n]));
        return n;
      },
    });
    const Rt = Oe.makeSpan;
    function Ht(e, t) {
      const r = Qe(e.body, t, !0);
      return Rt([e.mclass], r, t);
    }
    function Ot(e, t) {
      let r;
      const n = ft(e.body, t);
    ...
    Ye({
      ...
      mathmlBuilder(e, t) {
        let r = new mt.MathNode("mrow", [yt(e.label, t)]);
        return (
      ...
      Ye({
        ...
        mathmlBuilder: (e, t) => new mt.MathNode("mrow", [yt(e.fragment, t)]),
      }),
      Ye({
        type: "textord",
        names: ["\\@char"],
        ...
        handler(e, t) {
          let { parser: r } = e;
          const o = At(t[0], "ordgroup").body;
          let s = "";
          for (let e = 0; e < o.length; e++) s += At(o[e], "textord").text;
          let i,
            a = parseInt(s);
    ...
    const Pt = (e, t) => {
      ...
      Ft = (e, t) => {
        const r = ft(e.body, t.withColor(e.color)),
          n = new mt.MathNode("mstyle", r);
    ...
    Ye({
      ...
      handler(e, t) {
        let { parser: r } = e;
        const n = At(t[0], "color-token").color,
          o = t[1];
        return { type: "color", mode: r.mode, color: n, body: _e(o) };
      },
      htmlBuilder: Pt,
      mathmlBuilder: Ft,
    }),
      Ye({
        ...
        handler(e, t) {
          ...
          const o = At(t[0], "color-token").color;
    ...
    const Xt = function (e, t, r) {
      ...
      er = function (e, t, r, n, o, s) {
        ...
        if (m.length > 0) {
          ...
          if ((T.push($t(c, u, o)), T.push(Kt), null === a)) {
            const e = M - g - x + 0.016;
            T.push(Zt(h, e, n));
          } else {
        ...
        return Wt(Oe.makeSpan(["delimsizing", "mult"], [C], B), w.TEXT, n, s);
      },
      tr = 0.08,
      ...
      pr = function (e, t, r, n, o, s) {
        ...
        "<" === e || "\\lt" === e || "⟨" === e
          ? (e = "\\langle")
          : (">" !== e && "\\gt" !== e && "⟩" !== e) || (e = "\\rangle"),
          (i = l.contains(sr, e) ? ar : l.contains(nr, e) ? hr : lr);
        const a = mr(e, t, i, n);
        return "small" === a.type
    ...
    var ur = {
      sqrtImage: function (e, t) {
        const r = t.havingBaseSizing(),
          n = mr("\\surd", e * r.sizeMultiplier, hr, r);
          ...
          "small" === n.type
            ...
            : "large" === n.type
              ? ((c = 1080 * ir[n.size]),
                (h = (ir[n.size] + s) / o),
                (l = (ir[n.size] + s + tr) / o),
                (i = rr("sqrtSize" + n.size, l, c, s, t)),
                (i.style.minWidth = "1.02em"),
                (a = 1 / o))
              : ((l = e + s + tr),
                (h = e + s),
                (c = Math.floor(1e3 * e + s) + 80),
                (i = rr("sqrtTall", l, c, s, t)),
      ...
      sizedDelim: function (e, t, r, o, s) {
        if (
          ("<" === e || "\\lt" === e || "⟨" === e
            ? (e = "\\langle")
            : (">" !== e && "\\gt" !== e && "⟩" !== e) || (e = "\\rangle"),
          l.contains(nr, e) || l.contains(sr, e))
        )
          return jt(e, t, !1, r, o, s);
        if (l.contains(or, e)) return er(e, ir[t], !1, r, o, s);
    ...
    function fr(e, t) {
      const r = Bt(e);
      if (r && l.contains(gr, r.text)) return r;
      throw new n(
        r
    ...
    Ye({
      ...
      htmlBuilder: (e, t) =>
        "." === e.delim
          ...
          : ur.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
      mathmlBuilder: (e) => {
        const t = [];
        ...
        const n = P(ur.sizeToMaxHeight[e.size]);
      ...
      Ye({
        ...
        handler: (e, t) => {
          ...
          const s = At(n.parseFunction(), "leftright-right");
          return {
            type: "leftright",
            mode: n.mode,
            body: o,
        ...
        htmlBuilder: (e, t) => {
          ...
          if (
            ...
            (n =
              "." === e.left
                ? ot(t, ["mopen"])
                : ur.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"])),
            r.unshift(n),
            a)
          )
          ...
          if ("." === e.right) o = ot(t, ["mclose"]);
            ...
            o = ur.leftRightDelim(e.right, s, i, r, e.mode, ["mclose"]);
          }
      ...
      Ye({
        ...
        htmlBuilder: (e, t) => {
          ...
          if ("." === e.delim) r = ot(t, []);
            ...
            r = ur.sizedDelim(e.delim, 1, t, e.mode, []);
          ...
          /box/.test(n)
            ...
            (o = (function (e, t, r, n, o) {
              ...
              if (/fbox|color|angl/.test(t)) {
                ...
                const r = new Z(e, { width: "100%", height: P(i) });
    ...
    Ye({
      ...
      handler(e, t, r) {
        let { parser: n, funcName: o } = e;
        const s = At(t[0], "color-token").color,
          i = t[1];
        return {
          type: "enclose",
          mode: n.mode,
    ...
    function vr(e) {
      ...
      for (let e = 0; e < r.length; ++e) wr[r[e]] = a;
      s && (Ge[t] = s), i && (Ue[t] = i);
    }
    const kr = {};
    function Sr(e, t) {
      ...
      static range(e, t) {
        return t
          ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer
            ? new Mr(e.loc.lexer, e.loc.start, t.loc.end)
            : null
          : e && e.loc;
      }
    }
    class zr {
      ...
      range(e, t) {
        return new zr(t, Mr.range(this, e));
      }
    }
    function Ar(e) {
      const t = [];
      ...
      function w() {
        y &&
          (e.gullet.macros.get("\\df@tag")
            ? (y.push(e.subparse([new zr("\\df@tag")])),
    ...
    const qr = function (e, t) {
        ...
        if (((h = Oe.makeSpan(["mtable"], M)), c.length > 0)) {
          ...
          h = Oe.makeVList({ positionType: "individualShift", children: n }, t);
        }
      ...
      Rr = function (e, t) {
        ...
        for (let s = 0; s < e.body.length; s++) {
          ...
          for (let e = 0; e < i.length; e++)
            a.push(new mt.MathNode("mtd", [yt(i[e], t)]));
          e.tags &&
            e.tags[s] &&
      ...
      Hr = function (e, t) {
        ...
        if (t[0] && "ordgroup" === t[0].type) {
          ...
          for (let r = 0; r < t[0].body.length; r++)
            e += At(t[0].body[r], "textord").text;
          (a = Number(e)), (l = 2 * a);
        }
        const c = !l;
        i.body.forEach(function (e) {
          for (let t = 1; t < e.length; t += 2) {
            const r = At(e[t], "styling");
            At(r.body[0], "ordgroup").body.unshift(h);
          }
    ...
    vr({
      ...
      props: { numArgs: 1 },
      handler(e, t) {
        const r = (Bt(t[0]) ? [t[0]] : At(t[0], "ordgroup").body).map(
            function (e) {
              const t = Tt(e).text;
        ...
        return Cr(e.parser, o, Nr(e.envName));
      },
      htmlBuilder: qr,
      mathmlBuilder: Rr,
    }),
      vr({
        ...
        handler(e) {
          ...
          const s = Cr(e.parser, o, Nr(e.envName)),
      ...
      vr({
        ...
        props: { numArgs: 0 },
        handler(e) {
          const t = Cr(e.parser, { arraystretch: 0.5 }, "script");
    ...
    Ye({
      ...
      handler(e, t) {
        ...
        if ("\\begin" === o) {
          ...
          r.expect("\\end", !1);
          const h = r.nextToken,
            c = At(r.parseFunction(), "environment");
          if (c.name !== i)
            throw new n(
    ...
    const Vr = (e, t) => {
      ...
      Fr = (e, t) => {
        let r = new mt.MathNode("mfrac", [yt(e.numer, t), yt(e.denom, t)]);
        if (e.hasBarLine) {
          if (e.barSize) {
    ...
    const Gr = ["display", "text", "script", "scriptscript"],
      Ur = function (e) {
        let t = null;
    ...
    Ye({
      ...
      handler(e, t) {
        ...
        const n = t[4],
          o = t[5],
          s = We(t[0]),
          i = "atom" === s.type && "open" === s.family ? Ur(s.text) : null,
          a = We(t[1]),
          l = "atom" === a.type && "close" === a.family ? Ur(a.text) : null,
          h = At(t[2], "size");
        let c,
          m = null;
        ...
        if ("ordgroup" === u.type) {
          if (u.body.length > 0) {
            const e = At(u.body[0], "textord");
            p = Gr[Number(e.text)];
          }
        } else (u = At(u, "textord")), (p = Gr[Number(u.text)]);
        return {
          type: "genfrac",
          mode: r.mode,
          numer: n,
    ...
    Ye({
      ...
      Ye({
        ...
        handler: (e, t) => {
          ...
          return { type: "href", mode: r.mode, href: n, body: _e(s) };
        },
      }),
      Ye({
        type: "hbox",
        ...
        mathmlBuilder: (e, t) => new mt.MathNode("mrow", ft(e.body, t)),
      }),
      Ye({
        type: "html",
        ...
        handler: (e, t) => {
          ...
          return r.settings.isTrusted(l)
            ? { type: "html", mode: r.mode, attributes: h, body: _e(a) }
    ...
    Ye({
      ...
      handler: (e, t, r) => {
        let { parser: o } = e,
          ...
          l = "";
        if (r[0]) {
          const e = At(r[0], "raw").string.split(",");
          for (let t = 0; t < e.length; t++) {
            const r = e[t].split("=");
            if (2 === r.length) {
              const e = r[1].trim();
      ...
      Ye({
        ...
        htmlBuilder: (e, t) => Oe.makeGlue(e.dimension, t),
        mathmlBuilder(e, t) {
      ...
      Ye({
        ...
        mathmlBuilder: (e, t) => {
          const r = new mt.MathNode("mpadded", [yt(e.body, t)]);
          if ("rlap" !== e.alignment) {
    ...
    const _r = (e, t, r, n, o, s, i) => {
      ...
      $r = (e, t) => {
        let r,
          ...
          s = !1;
        "supsub" === e.type
          ? ((r = e.sup), (n = e.sub), (o = At(e.base, "op")), (s = !0))
          : (o = At(e, "op"));
        const i = t.style;
        let a,
          h = !1;
        ...
        let c = 0,
          m = 0;
        return (
          (a instanceof $ || "\\oiint" === o.name || "\\oiiint" === o.name) &&
            !o.suppressBaseShift &&
            ((c = (a.height - a.depth) / 2 - t.fontMetrics().axisHeight),
            (m = a.italic)),
          s
            ? _r(a, r, n, t, i, m, c)
            : (c && ((a.style.position = "relative"), (a.style.top = P(c))), a)
        );
      },
      Zr = (e, t) => {
        let r;
        if (e.symbol)
          (r = new ht("mo", [pt(e.name, e.mode)])),
            l.contains(jr, e.name) && r.setAttribute("largeop", "false");
        else if (e.body) r = new ht("mo", ft(e.body, t));
        else {
    ...
    const Qr = (e, t) => {
      ...
      return i ? _r(s, r, n, t, t.style, 0, 0) : s;
    };
    function en(e, t, r) {
      const n = Qe(e, t, !1),
    ...
    Ye({
      ...
      htmlBuilder: Qr,
      mathmlBuilder: (e, t) => {
        let r = ft(e.body, t.withFont("mathrm")),
          n = !0;
        for (let e = 0; e < r.length; e++) {
          const t = r[e];
      ...
      Sr("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"),
      Xe({
        type: "ordgroup",
        htmlBuilder: (e, t) =>
          e.semisimple
        ...
        mathmlBuilder: (e, t) => bt(e.body, t, !0),
      }),
      Ye({
        type: "overline",
        names: ["\\overline"],
        ...
        mathmlBuilder(e, t) {
          ...
          r.setAttribute("stretchy", "true");
          const n = new mt.MathNode("mover", [yt(e.body, t), r]);
          return n.setAttribute("accent", "true"), n;
        },
      }),
      Ye({
      ...
      Ye({
        ...
        htmlBuilder(e, t) {
          ...
          const i = r.height + r.depth + s + n,
            { span: a, ruleWidth: l, advanceWidth: h } = ur.sqrtImage(i, t),
            c = a.height - l;
        ...
        mathmlBuilder(e, t) {
          ...
          return n
            ? new mt.MathNode("mroot", [yt(r, t), yt(n, t)])
            : new mt.MathNode("msqrt", [yt(r, t)]);
        },
      });
    const rn = {
      display: w.DISPLAY,
    ...
    Ye({
      ...
      Xe({
        ...
        htmlBuilder(e, t) {
          ...
          let d;
          d =
            t.style === w.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
              ...
              (b = Oe.makeVList(
                {
                  ...
                  positionData: p,
                  children: [
                    { type: "elem", elem: h, marginLeft: y, marginRight: f },
                  ],
                },
                t,
              ));
        ...
        mathmlBuilder(e, t) {
          ...
          const s = [yt(e.base, t)];
          let i;
          if ((e.sub && s.push(yt(e.sub, t)), e.sup && s.push(yt(e.sup, t)), o))
            i = r ? "mover" : "munder";
          else if (e.sub)
            if (e.sup) {
              const r = e.base;
      ...
      Xe({
        type: "atom",
        htmlBuilder: (e, t) => Oe.mathsym(e.text, e.mode, t, ["m" + e.family]),
        mathmlBuilder(e, t) {
    ...
    const nn = { mi: "italic", mn: "normal", mtext: "normal" };
    Xe({
      type: "mathord",
      htmlBuilder: (e, t) => Oe.makeOrd(e, t, "mathord"),
      mathmlBuilder(e, t) {
        const r = new mt.MathNode("mi", [pt(e.text, e.mode, t)]),
          n = dt(e, t) || "italic";
        return n !== nn[r.type] && r.setAttribute("mathvariant", n), r;
      },
    }),
      Xe({
        type: "textord",
        htmlBuilder: (e, t) => Oe.makeOrd(e, t, "textord"),
        mathmlBuilder(e, t) {
          ...
          return (
            ...
            n !== nn[o.type] && o.setAttribute("mathvariant", n),
            o
          );
        },
      });
    ...
    Xe({
      ...
      htmlBuilder(e, t) {
        ...
        if (on.hasOwnProperty(e.text))
          return Oe.makeSpan(["mspace", on[e.text]], [], t);
        throw new n('Unknown type of space "' + e.text + '"');
      },
      mathmlBuilder(e, t) {
        let r;
        if (!sn.hasOwnProperty(e.text)) {
          if (on.hasOwnProperty(e.text)) return new mt.MathNode("mspace");
          throw new n('Unknown type of space "' + e.text + '"');
        }
    ...
    Xe({
      ...
      mathmlBuilder(e, t) {
        const r = new mt.MathNode("mtable", [
          new mt.MathNode("mtr", [
            an(),
            new mt.MathNode("mtd", [bt(e.body, t)]),
            an(),
            new mt.MathNode("mtd", [bt(e.tag, t)]),
          ]),
        ]);
    ...
    const ln = {
      ...
      mn = (e, t) => {
        ...
        return r
          ? ln[r]
            ? t.withTextFontFamily(ln[r])
            : hn[r]
              ? t.withTextFontWeight(hn[r])
              : "\\emph" === r
                ? "textit" === t.fontShape
    ...
    Ye({
      ...
      Ye({
        ...
        mathmlBuilder(e, t) {
          const r = new mt.MathNode("mo", [new mt.TextNode("‾")]);
          r.setAttribute("stretchy", "true");
          const n = new mt.MathNode("munder", [yt(e.body, t), r]);
          return n.setAttribute("accentunder", "true"), n;
        },
      }),
      Ye({
        ...
        mathmlBuilder: (e, t) =>
          new mt.MathNode("mpadded", [yt(e.body, t)], ["vcenter"]),
      }),
      Ye({
        type: "verb",
        names: ["\\verb"],
        ...
        mathmlBuilder(e, t) {
          const r = new mt.TextNode(pn(e)),
            n = new mt.MathNode("mtext", [r]);
          return n.setAttribute("mathvariant", "monospace"), n;
        },
      });
    const pn = (e) => e.body.replace(/ /g, e.star ? "␣" : " ");
    var un = Fe;
    const dn = "[ \r\n\t]",
      gn = "(\\\\[a-zA-Z@]+)" + dn + "*",
      fn = "[̀-ͯ]",
    ...
    class xn {
      constructor(e, t) {
        (this.input = void 0),
          ...
          (this.input = e),
          (this.settings = t),
          (this.tokenRegex = new RegExp(yn, "g")),
          (this.catcodes = { "%": 14, "~": 13 });
      }
      setCatcode(e, t) {
        this.catcodes[e] = t;
      ...
      lex() {
        ...
        return new zr(o, new Mr(this, t, this.tokenRegex.lastIndex));
      }
    }
    class wn {
      constructor(e, t) {
    ...
    Sr("\\char", function (e) {
      ...
      if (t) {
        if (((o = kn[r.text]), null == o || o >= t))
          throw new n("Invalid base-" + t + " digit " + r.text);
        let s;
        for (; null != (s = kn[e.future().text]) && s < t; )
          (o *= t), (o += s), e.popToken();
      }
      return "\\@char{" + o + "}";
    });
    ...
    Sr("\\newcommand", (e) => Sn(e, !1, !0, !1)),
      Sr("\\renewcommand", (e) => Sn(e, !0, !1, !1)),
      Sr("\\providecommand", (e) => Sn(e, !0, !0, !0)),
      Sr("\\message", (e) => {
      ...
      Sr("\\show", (e) => {
        const t = e.popToken(),
          r = t.text;
        return (
          console.log(t, e.macros.get(r), un[r], ne.math[r], ne.text[r]), ""
        );
      }),
      Sr("\\bgroup", "{"),
      Sr("\\egroup", "}"),
      ...
      Sr("\\aa", "\\r a"),
      Sr("\\AA", "\\r A"),
      Sr("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`©}"),
      Sr(
        "\\copyright",
      ...
      Sr("\\mathstrut", "\\vphantom{(}"),
      Sr("\\underbar", "\\underline{\\text{#1}}"),
      ...
      Sr("≚", "\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`≚}}"),
      Sr(
        "≛",
      ...
      Sr("≟", "\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`≟}}"),
      Sr("⟂", "\\perp"),
      ...
      Sr("®", "\\textregistered"),
      Sr("️", "\\textregistered"),
      Sr("\\ulcorner", '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      Sr("\\urcorner", '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      Sr("\\llcorner", '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      Sr("\\lrcorner", '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      Sr("\\vdots", "{\\varvdots\\rule{0pt}{15pt}}"),
      Sr("⋮", "\\vdots"),
      ...
      Sr("\\substack", "\\begin{subarray}{c}#1\\end{subarray}"),
      Sr(
        "\\colon",
      ...
      Sr("\\dddot", "{\\overset{\\raisebox{-0.1ex}{\\normalsize ...}}{#1}}"),
      Sr("\\ddddot", "{\\overset{\\raisebox{-0.1ex}{\\normalsize ....}}{#1}}");
    const Mn = {
      ",": "\\dotsc",
      "\\not": "\\dotsb",
      "+": "\\dotsb",
    ...
    Sr("\\dots", function (e) {
      ...
      return (
        r in Mn
          ? (t = Mn[r])
          : ("\\not" === r.slice(0, 4) ||
              (r in ne.math && l.contains(["bin", "rel"], ne.math[r].group))) &&
            (t = "\\dotsb"),
        t
      );
    });
    ...
    Sr("\\dotso", function (e) {
      return e.future().text in zn ? "\\ldots\\," : "\\ldots";
    }),
      Sr("\\dotsc", function (e) {
        const t = e.future().text;
        return t in zn && "," !== t ? "\\ldots\\," : "\\ldots";
      }),
      Sr("\\cdots", function (e) {
        return e.future().text in zn ? "\\@cdots\\," : "\\@cdots";
      }),
      Sr("\\dotsb", "\\cdots"),
      Sr("\\dotsm", "\\cdots"),
      Sr("\\dotsi", "\\!\\cdots"),
    ...
    Sr(
      ...
      Sr("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
      Sr(
        "\\simcoloncolon",
      ...
      Sr("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`∌}}"),
      Sr("\\limsup", "\\DOTSB\\operatorname*{lim\\,sup}"),
      Sr("\\liminf", "\\DOTSB\\operatorname*{lim\\,inf}"),
      Sr("\\injlim", "\\DOTSB\\operatorname*{inj\\,lim}"),
      Sr("\\projlim", "\\DOTSB\\operatorname*{proj\\,lim}"),
      Sr("\\varlimsup", "\\DOTSB\\operatorname*{\\overline{lim}}"),
      Sr("\\varliminf", "\\DOTSB\\operatorname*{\\underline{lim}}"),
      Sr("\\varinjlim", "\\DOTSB\\operatorname*{\\underrightarrow{lim}}"),
      Sr("\\varprojlim", "\\DOTSB\\operatorname*{\\underleftarrow{lim}}"),
      Sr("\\gvertneqq", "\\html@mathml{\\@gvertneqq}{≩}"),
      Sr("\\lvertneqq", "\\html@mathml{\\@lvertneqq}{≨}"),
      ...
      Sr("\\varsubsetneq", "\\html@mathml{\\@varsubsetneq}{⊊}"),
      Sr("\\varsubsetneqq", "\\html@mathml{\\@varsubsetneqq}{⫋}"),
      Sr("\\varsupsetneq", "\\html@mathml{\\@varsupsetneq}{⊋}"),
      Sr("\\varsupsetneqq", "\\html@mathml{\\@varsupsetneqq}{⫌}"),
      Sr("\\imath", "\\html@mathml{\\@imath}{ı}"),
      Sr("\\jmath", "\\html@mathml{\\@jmath}{ȷ}"),
      Sr(
        "\\llbracket",
      ...
      Sr("\\Complex", "\\mathbb{C}"),
      Sr("\\Dagger", "\\ddagger"),
      Sr("\\diamonds", "\\diamondsuit"),
      Sr("\\empty", "\\emptyset"),
      Sr("\\Epsilon", "\\mathrm{E}"),
      Sr("\\Eta", "\\mathrm{H}"),
      Sr("\\exist", "\\exists"),
      Sr("\\harr", "\\leftrightarrow"),
      Sr("\\hArr", "\\Leftrightarrow"),
      Sr("\\Harr", "\\Leftrightarrow"),
      Sr("\\hearts", "\\heartsuit"),
      Sr("\\image", "\\Im"),
      ...
      Sr("\\weierp", "\\wp"),
      Sr("\\Zeta", "\\mathrm{Z}"),
      Sr("\\argmin", "\\DOTSB\\operatorname*{arg\\,min}"),
      Sr("\\argmax", "\\DOTSB\\operatorname*{arg\\,max}"),
      Sr("\\plim", "\\DOTSB\\mathop{\\operatorname{plim}}\\limits"),
      Sr("\\bra", "\\mathinner{\\langle{#1}|}"),
      Sr("\\ket", "\\mathinner{|{#1}\\rangle}"),
      Sr("\\braket", "\\mathinner{\\langle{#1}\\rangle}"),
      Sr("\\Bra", "\\left\\langle#1\\right|"),
      Sr("\\Ket", "\\left|#1\\right\\rangle");
    const Tn = (e) => (t) => {
      ...
      const l = (t) => (r) => {
        ...
        let s = t;
        return (
          !t && o.length && "|" === r.future().text && (r.popToken(), (s = !0)),
    ...
    Sr("\\bra@ket", Tn(!1)),
      ...
      Sr("\\set", "\\bra@set{\\{\\,}{\\mid}{}{\\,\\}}"),
      Sr("\\angln", "{\\angl n}"),
      Sr("\\blue", "\\textcolor{##6495ed}{#1}"),
      Sr("\\orange", "\\textcolor{##ffa500}{#1}"),
      Sr("\\pink", "\\textcolor{##ff00af}{#1}"),
      Sr("\\red", "\\textcolor{##df0030}{#1}"),
      Sr("\\green", "\\textcolor{##28ae7b}{#1}"),
      Sr("\\gray", "\\textcolor{gray}{#1}"),
      Sr("\\purple", "\\textcolor{##9d38bd}{#1}"),
      Sr("\\blueA", "\\textcolor{##ccfaff}{#1}"),
      Sr("\\blueB", "\\textcolor{##80f6ff}{#1}"),
      Sr("\\blueC", "\\textcolor{##63d9ea}{#1}"),
      Sr("\\blueD", "\\textcolor{##11accd}{#1}"),
      Sr("\\blueE", "\\textcolor{##0c7f99}{#1}"),
      Sr("\\tealA", "\\textcolor{##94fff5}{#1}"),
      Sr("\\tealB", "\\textcolor{##26edd5}{#1}"),
      Sr("\\tealC", "\\textcolor{##01d1c1}{#1}"),
      Sr("\\tealD", "\\textcolor{##01a995}{#1}"),
      Sr("\\tealE", "\\textcolor{##208170}{#1}"),
      Sr("\\greenA", "\\textcolor{##b6ffb0}{#1}"),
      Sr("\\greenB", "\\textcolor{##8af281}{#1}"),
      Sr("\\greenC", "\\textcolor{##74cf70}{#1}"),
      Sr("\\greenD", "\\textcolor{##1fab54}{#1}"),
      Sr("\\greenE", "\\textcolor{##0d923f}{#1}"),
      Sr("\\goldA", "\\textcolor{##ffd0a9}{#1}"),
      Sr("\\goldB", "\\textcolor{##ffbb71}{#1}"),
      Sr("\\goldC", "\\textcolor{##ff9c39}{#1}"),
      Sr("\\goldD", "\\textcolor{##e07d10}{#1}"),
      Sr("\\goldE", "\\textcolor{##a75a05}{#1}"),
      Sr("\\redA", "\\textcolor{##fca9a9}{#1}"),
      Sr("\\redB", "\\textcolor{##ff8482}{#1}"),
      Sr("\\redC", "\\textcolor{##f9685d}{#1}"),
      Sr("\\redD", "\\textcolor{##e84d39}{#1}"),
      Sr("\\redE", "\\textcolor{##bc2612}{#1}"),
      Sr("\\maroonA", "\\textcolor{##ffbde0}{#1}"),
      Sr("\\maroonB", "\\textcolor{##ff92c6}{#1}"),
      Sr("\\maroonC", "\\textcolor{##ed5fa6}{#1}"),
      Sr("\\maroonD", "\\textcolor{##ca337c}{#1}"),
      Sr("\\maroonE", "\\textcolor{##9e034e}{#1}"),
      Sr("\\purpleA", "\\textcolor{##ddd7ff}{#1}"),
      Sr("\\purpleB", "\\textcolor{##c6b9fc}{#1}"),
      Sr("\\purpleC", "\\textcolor{##aa87ff}{#1}"),
      Sr("\\purpleD", "\\textcolor{##7854ab}{#1}"),
      Sr("\\purpleE", "\\textcolor{##543b78}{#1}"),
      Sr("\\mintA", "\\textcolor{##f5f9e8}{#1}"),
      Sr("\\mintB", "\\textcolor{##edf2df}{#1}"),
      Sr("\\mintC", "\\textcolor{##e0e5cc}{#1}"),
      Sr("\\grayA", "\\textcolor{##f6f7f7}{#1}"),
      Sr("\\grayB", "\\textcolor{##f0f1f2}{#1}"),
      Sr("\\grayC", "\\textcolor{##e3e5e6}{#1}"),
      Sr("\\grayD", "\\textcolor{##d6d8da}{#1}"),
      Sr("\\grayE", "\\textcolor{##babec2}{#1}"),
      Sr("\\grayF", "\\textcolor{##888d93}{#1}"),
      Sr("\\grayG", "\\textcolor{##626569}{#1}"),
      Sr("\\grayH", "\\textcolor{##3b3e40}{#1}"),
      Sr("\\grayI", "\\textcolor{##21242c}{#1}"),
      Sr("\\kaBlue", "\\textcolor{##314453}{#1}"),
      Sr("\\kaGreen", "\\textcolor{##71B307}{#1}");
    const Bn = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 };
    class Cn {
      constructor(e, t, r) {
        (this.settings = void 0),
          ...
          this.feed(e),
          (this.macros = new wn(vn, t.macros)),
          (this.mode = r),
          (this.stack = []);
      }
      feed(e) {
      ...
      isExpandable(e) {
        ...
        return null != t
          ...
          : un.hasOwnProperty(e) && !un[e].primitive;
      }
    }
    const Nn =
    ...
    class Hn {
      ...
      parseExpression(e, t) {
        ...
        for (;;) {
          ...
          const n = this.fetch();
          if (-1 !== Hn.endOfExpression.indexOf(n.text)) break;
          if (t && n.text === t) break;
          if (e && un[n.text] && un[n.text].infix) break;
      ...
      parseAtom(e) {
        ...
        for (;;) {
          ...
          if ("\\limits" === e.text || "\\nolimits" === e.text) {
            ...
            if (!qn[e.text]) break;
            {
              const t = Nn.test(e.text),
                n = [];
              for (n.push(new zr(qn[e.text])), this.consume(); ; ) {
                const e = this.fetch().text;
                if (!qn[e]) break;
                if (Nn.test(e) !== t) break;
                n.unshift(new zr(qn[e])), this.consume();
              }
      ...
      parseGroup(e, t) {
        ...
        if ("{" === o || "\\begingroup" === o) {
          ...
          null == s && "\\" === o[0] && !Bn.hasOwnProperty(o))
        ) {
      ...
      parseSymbol() {
        ...
        if (
          ...
          this.settings.strict &&
            ...
            (o = { type: "textord", mode: "text", loc: Mr.range(e), text: t });
        }
        if ((this.consume(), r))
          for (let t = 0; t < r[0].length; t++) {
            const s = r[0][t];
            if (!In[s]) throw new n("Unknown accent ' " + s + "'", e);
            const i = In[s][this.mode] || In[s].text;
            if (!i)
              throw new n(
      ...
      Dn = function (e, t) {
        ...
        try {
          return (function (e, t, r) {
            const n = wt(r);
            let o;
            if ("mathml" === r.output) return xt(e, t, n, r.displayMode, !0);
            if ("html" === r.output) {
              const t = at(e, n);
              o = Oe.makeSpan(["katex"], [t]);
            } else {
              const s = xt(e, t, n, r.displayMode, !1),
                i = at(e, n);
